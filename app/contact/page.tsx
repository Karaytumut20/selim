...
export const metadata: Metadata = pageMetadata({ title: "Contact & Request a Repair", description: "Request an industrial circuit board repair evaluation by WhatsApp. Share product identity, part number, symptoms, and photos without creating an account.", path: "/contact" });

export default function ContactPage() {
  return <PageShell><JsonLd data={breadcrumbJsonLd([{ name: "Home", path: "/" }, { name: "Contact", path: "/contact" }])} /><PageHero index="06 / REPAIR REQUEST" eyebrow="Direct repair intake" title="Put the board details in one clear message." intro="Complete the guided form and the site will prepare a WhatsApp message. Nothing is stored or uploaded by this website." aside="Work begins only after evaluation, quotation, and approval." />
