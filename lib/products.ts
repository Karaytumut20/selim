...
export const products: Product[] = [
  ...
  {
    id: "m-720", slug: "m-720-cnc-axis-control-board", name: "M-720 CNC Axis Control Board", partNumber: "M-720", manufacturerOrFamily: "M Series", category: "Industrial Control Boards", shortDescription: "Axis control electronics for CNC motion systems.", longDescription: "Generic CNC axis control board for preliminary repair feasibility evaluation.", repairSupported: false, typicalFaults: ["Axis error", "Output failure", "Intermittent operation"], repairCapabilities: ["Inspection available", "Repair scope confirmed after evaluation"], leadTimeText: "Evaluation required before repair support is confirmed", warrantyText: "Warranty terms depend on confirmed scope", image: "cnc", gallery: ["cnc", "drive"], specifications: { "Product family": "M Series", "Board class": "Axis control" }, relatedProductIds: ["m-610", "s-420"], featured: false, primaryProduct: false,
  },
  {
